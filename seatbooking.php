...
<div class="container">
    ...
    <div class="col-lg-6">
        ...
        <table>
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Travels:</font></td>
                <td bgcolor="79F9E2"><center><font size=5 style="font-family: Shruti; "><?php echo $_GET['movie'];?></font></center></td>
            </tr>
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Timing:</font></td>
