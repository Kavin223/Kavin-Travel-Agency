...
<div class="card ">
                <div class="card-header">
                    ...
                    <h6> Near Government Hospital, Erode</h6></center>
                    <?php 
                ...
                ?>
                    ...
                    <center><h3>Travels Name: <?php echo $row['movie'];?></h3></center>
                   ...
                   <table>
                   	<tr>
                   	<th>bus_id</th><th style="padding: 0px 2px 0px 60px">Date</th><th style="padding-left: 30px;">Time</th>
                   </tr>
                   <tr>
